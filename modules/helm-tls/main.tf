...
resource "local_file" "ca_cert" {
  filename = "${local.tls_dir}/${var.ca_cert_filename}"
...
resource "local_file" "tiller_key" {
  filename = "${local.tls_dir}/${var.tiller_key_filename}"
  content  = "${tls_private_key.tiller_server.private_key_pem}"
}

resource "local_file" "tiller_cert" {
  filename = "${local.tls_dir}/${var.tiller_cert_filename}"
...
resource "local_file" "helm_key" {
  filename = "${local.tls_dir}/${var.helm_key_filename}"
  content  = "${tls_private_key.helm_client.private_key_pem}"
}

resource "local_file" "helm_cert" {
  filename = "${local.tls_dir}/${var.helm_cert_filename}"
